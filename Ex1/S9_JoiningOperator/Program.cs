...
namespace S9_JoiningOperator
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            /* select studentList.StudentName, standardList.StandardName
              from  studentList 
              join  standardList on student.StandardID = standard.StandardID
             */
